...
# Configure logging
logging.basicConfig(
    filename="./Wayverlay-Golfclub-Data/scraper.log",
    level=logging.INFO,
...
class GolfClubScraper:
    ...
    def export_to_excel(self, course_name, course_data):
        ...
        with pd.ExcelWriter(f"./Wayverlay-Golfclub-Data/{course_name}.xlsx") as writer:
...
base_url = "https://www.waverleygolfclub.com.au/guests/bookings/ViewPublicCalendar.msp?booking_resource_id=3000000"
course_url = "https://www.waverleygolfclub.com.au/guests/bookings/ViewPublicTimesheet.msp?bookingResourceId=3000000"
